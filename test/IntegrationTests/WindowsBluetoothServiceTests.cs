...
namespace BleLib.Tests.IntegrationTests
{
    public class WindowsBluetoothServiceTests
    {
        ...
        public async Task PlatformSpecificBehavior_ShouldWorkCorrectly()
        {
            ...
            // On Windows, we should be able to create and use the Windows Bluetooth service
...
#else
            // On non-Windows platforms, the factory should return the appropriate service for that platform
            var service = BluetoothServiceFactory.CreateBluetoothService();
            
            // The service should be the appropriate service for the current platform
            service.Should().NotBeNull();
            
            // We can't directly test that it's not a Windows service due to interface abstraction,
        ...
        public WindowsBluetoothServiceTests()
        {
